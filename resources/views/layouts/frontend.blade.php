                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> kelompok4.bootcamp.com</li>
                                <li>Diskon 5% Setiap pembelian 1 Unit labtop gaming</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="/"><img src="{{ asset('frontend/img/logomsi.jpeg') }}" alt="" /></a>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="./index.html"><img src="{{ asset('frontend/img/logomsi.jpeg') }}"
                                    alt="" /></a>
                        </div>
                        <ul>
                            <li>Address: 60-49 Road 11378 Unilak</li>
                            <li>Phone: +6282371299037</li>
                            <li>Email: kelompok4.bootcamp.com</li>
                        </ul>
                    </div>
                </div>
